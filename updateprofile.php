...
//update
$sql="UPDATE user SET password='$_POST[password]', fname='$_POST[f_fname]', lname='$_POST[l_lname]', phoneno='$_POST[p_pnum]', gender='$_POST[g_gender]' WHERE email='$_POST[e_email]'";
