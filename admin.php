                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Dashboard <small>Summary of Tomorrowland Event</small>
                        </h1>
                    </div>
                </div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                <!--  <th>Manage</th> -->
                                  ...
                                  ?>
                                        <tr class="odd gradeX">
                                        <form method="POST" action="updateuserticket.php">
...
<!-- DATA TABLE SCRIPTS WORKING SCRIPTS-->
